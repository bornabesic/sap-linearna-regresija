...
\begin{Highlighting}[]
\KeywordTok{help}\NormalTok{(plot)}
\KeywordTok{plot}\NormalTok{(N,urod,}\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{2000}\NormalTok{, }\DecValTok{4200}\NormalTok{), }\DataTypeTok{xlab=}\StringTok{"broj dana proteklih od sjetve zita"}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{"Urod, (kg/ha)"}\NormalTok{,}\DataTypeTok{main=}\StringTok{"Utjecaj datuma zetve na urod"}\NormalTok{)}
