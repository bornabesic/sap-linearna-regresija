...
\KeywordTok{plot}\NormalTok{(X, model$residuals, }\DataTypeTok{xlab=}\StringTok{'Vrijeme [t]'}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{'Iznos reziduala'}\NormalTok{,}
...
\KeywordTok{plot}\NormalTok{(X, residuals.standardized, }\DataTypeTok{xlab=}\StringTok{'Vrijeme [t]'}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{'Iznos reziduala'}\NormalTok{,}
...
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(X, model.ln$residuals, }\DataTypeTok{xlab=}\StringTok{'Vrijeme [t]'}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{'Iznos reziduala'}\NormalTok{,}
     \DataTypeTok{main =} \StringTok{'Graf reziduala'}\NormalTok{)}
\NormalTok{residuals.ln.standardized <-}\StringTok{ }\KeywordTok{rstandard}\NormalTok{(model.ln)}
\KeywordTok{plot}\NormalTok{(X, residuals.ln.standardized, }\DataTypeTok{xlab=}\StringTok{'Vrijeme [t]'}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{'Iznos reziduala'}\NormalTok{,}
     \DataTypeTok{main =} \StringTok{'Graf standardiziranih reziduala'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{plot}\NormalTok{(N, model$residuals, }\DataTypeTok{xlab=}\StringTok{'Broj dana proteklih od sjetve žita'}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{'Iznos reziduala'}\NormalTok{,}
     \DataTypeTok{main =} \StringTok{'Graf reziduala'}\NormalTok{)}

\KeywordTok{plot}\NormalTok{(N, }\KeywordTok{rstandard}\NormalTok{(model), }\DataTypeTok{xlab=}\StringTok{'Broj dana proteklih od sjetve žita'}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{'Iznos reziduala'}\NormalTok{,}
     \DataTypeTok{main =} \StringTok{'Graf standardiziranih reziduala'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Izvjestaj_files/figure-latex/unnamed-chunk-25-2.pdf}
